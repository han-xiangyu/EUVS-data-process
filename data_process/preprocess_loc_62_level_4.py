    ...
    for traversal_idx in merged_traversal_idxes:
        ...
        for idx, sample_token in enumerate(all_sample_tokens):
            ...
            if idx not in skip_indices: ########### Sample data in certain ratio ##############
                ...
                if traversal_idx == 6 and idx>114:
                    continue
                if traversal_idx == 7 and (60<idx<730 or idx>842):
                    continue
                elif traversal_idx == 11 and 50<idx<485:
                    continue
                elif traversal_idx == 13 and 60<idx<820:
                    continue
                elif traversal_idx == 23 and (idx<546 or idx>684):
                    continue
                elif traversal_idx == 22 and 84<idx<878:
                    continue
                # Get ego poses
...
def main():
    ...
    # case 0
    output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_62_case_1_testset_incremental'
    # trainset_idxes = [5,28,30,41,44,45] # front all, sample rate 1/6
    trainset_idxes = []
    testset_idxes = [6,7,11,13,23]  # front only, sample rate 1/4
    train_sample_ratio = 1/6
    ...
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_62_case_1_middle_lane_change'
    # trainset_idxes = [5,28,30,41,44,45] # front all, sample rate 1/6
    ...
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_62_case_2_right_lane_change'
    # trainset_idxes = [5,28,30,41,44,45] # front all, sample rate 1/6
    ...
    # # case 3 cross
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_62_case_3_cross'
    # trainset_idxes = [6,7,11,13,23] # front all, sample rate 5/12
    # testset_idxes = [47]  # front all, sample rate 1/2
    # train_sample_ratio = 5/12
