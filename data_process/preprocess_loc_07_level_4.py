...
def main():
    ...
    nusc = NuScenes(version='v1.1', dataroot=f'./location_07/7', verbose=True)

    # case 1 middle lane change
    output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_07_case_1_T_cross'
    trainset_idxes = [5,6,7,10,12,13] # front all, sample rate 1/4
    testset_idxes = [32] # front only, sample rate 2/3
    train_sample_ratio = 1/4
    test_sample_ratio = 2/3
    train_sensors = [
            'CAM_FRONT_CENTER',
            'CAM_FRONT_LEFT',
            'CAM_FRONT_RIGHT',
