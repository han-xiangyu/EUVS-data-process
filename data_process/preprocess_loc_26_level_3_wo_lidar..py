...
def main():
    ...
    nusc = NuScenes(version='v1.1', dataroot=f'./location_26/26', verbose=True)

    output_dir = './location_26/downsampled_multitraversal/front_train_side_test'
    # traversal_idxes = list(range(0, 51))

    # right lane change
    traversal_idxes=[11,13,14,18,31,33,34,35] # location 06 10days front only train, side test
    traversal_idxes=[2,11,14,15,58,56,62,24] # location 26 front only
