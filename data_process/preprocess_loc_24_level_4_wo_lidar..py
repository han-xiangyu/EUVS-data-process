...
def main():
    ...
    output_dir = './location_24/downsampled_multitraversal/case_1_testset_only'
    # traversal_idxes = list(range(0, 51))
    testset_idxes = []
    # case 1 cross straight and right strait
    # traversal_idxes = [0,1,4,5,13,14] # front all, sample rate 1/5
    traversal_idxes = []
    testset_idxes = [18] # sample rate 3/4, front center only

    # case 2 cross straight and left strait
    # traversal_idxes = [0,1,4,5,13,14] # front all, sample rate 1/5
    # testset_idxes = [83] # sample rate 3/4, front center only

    # case 3 T cross 
    # traversal_idxes = [0,1,4,5,13,14] # front all, sample rate 1/5
    # testset_idxes = [7] # front all, sample rate 1/3
