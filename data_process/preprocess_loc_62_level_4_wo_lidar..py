...
def main():
    ...
    # traversal_idxes = [11,13,14,20,21,22,23,30,47,50] # location 62_v1
    # traversal_idxes = [5,28,30,45,41] 
    # testset_idx = [62,24] # location 26 all cam testset
    # traversal_idxes = [5,30,41,45,6,11,21,22,23] # location 62 large view change
    # traversal_idxes = list(range(0, 100))
    # testset_idxes = []
    # traversal_idxes = [5,28,30,44,45,41] 
    # 22 lane change test
