    ...
    for traversal_idx in merged_traversal_idxes:
        ...
        for idx, sample_token in enumerate(all_sample_tokens):
            ...
            if idx not in skip_indices: ########### Sample data in certain ratio ##############
                ...
                if traversal_idx == 0 and (idx<31 or (139<idx<193)):
                    continue
                # Get ego poses
...
def main():
    ...
    nusc = NuScenes(version='v1.1', dataroot=f'./location_24/24', verbose=True)

    # # case 1 T cross better
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_24_case_1_T_cross'
    # trainset_idxes = [0,1,4,5,13,14] # front all, sample rate 1/5
    # testset_idxes = [7] # front all, sample rate 1/4
    ...
    # # case 2 T cross
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_24_case_2_T_cross'
    # trainset_idxes = [6,9] # front all, sample rate 1/2
    # testset_idxes = [8] # front all, sample rate 1/4
    # train_sample_ratio = 3/5
    # test_sample_ratio = 1/5
    # train_sensors = [
    #         'CAM_FRONT_CENTER',
    #         'CAM_FRONT_LEFT',
    #         'CAM_FRONT_RIGHT',
    ...
    # # case 3 cross
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_24_case_3_cross/testset'
    # # trainset_idxes = [4,5,13,14] # front all, sample rate 1/2
    # trainset_idxes = []
    # testset_idxes = [83] # front all, sample rate 1/4
    ...
    # case 4 cross
    output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_24_case_4_cross/testset'
    # trainset_idxes = [4,5,13,14] # front all, sample rate 1/2
    trainset_idxes = []
    testset_idxes = [18] # front all, sample rate 1/4
    train_sample_ratio = 1/4
    test_sample_ratio = 1/4
    train_sensors = [
            'CAM_FRONT_CENTER',
    ...
    # # case 1 cross  双向（不好）
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_24_case_1_cross'
    # trainset_idxes = [4,13,14,6,9] # front all, sample rate 1/5
    # testset_idxes = [7] # front all, sample rate 1/4
    ...
    # # case 2 cross 双向（不好）
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_24_case_2_cross'
    # trainset_idxes = [4,13,14,6,9] # front all, sample rate 1/5
    # testset_idxes = [8] # front all, sample rate 1/4
    # train_sample_ratio = 1/5
    # test_sample_ratio = 1/4
