...
def main():
    ...
    output_dir = './location_07/downsampled_multitraversal/cross'
    # traversal_idxes = list(range(0, 51))

    # right lane change
    traversal_idxes = [5,6,7,10,12,13] # front all, sample rate 1/4
    testset_idxes = [32] # front all, sample rate 1/2
    # testset_idxes = [] # front all, sample rate 1/2
