...
def main():
    ...
    nusc = NuScenes(version='v1.1', dataroot=f'./location_11/11', verbose=True)

    # case 1 cross 1
    output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_11_case_1'
    trainset_idxes = [1,3,4,5,6,7] # front all, sample rate 
    testset_idxes = [0,15,17] # front all, sample rate 
    train_sample_ratio = 2/5
