    ...
    for traversal_idx in traversal_idxes:
        ...
        for idx, sample_token in enumerate(all_sample_tokens):
            ...
            for sensor_channel in sensors_mike:
                ...
                output_path = os.path.join(image_output_dir_mike, f"{traversal_idx}_{channel_idx}_{img_idx}_mike.jpg")
                ...
                key = f"{traversal_idx}_{channel_idx}_{img_idx}"
...
def main():
    ...
    nusc = NuScenes(version='v1.0', dataroot=f'./scene_3_raw_data', verbose=True)

    output_dir = './scene_3_preprocessed_data/traversal_0/extra_data'
    # scene_idxes = [1, 10]
    traversal_idxes = [0]
