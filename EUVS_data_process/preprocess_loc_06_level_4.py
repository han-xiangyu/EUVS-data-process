...
def main():
    ...
    nusc = NuScenes(version='v1.1', dataroot=f'/home/xiangyu/Ultra/MARS_multitraversal/location_06_10days/6', verbose=True)

    # case 1 cross 1
    output_dir = '/home/xiangyu/Common/loc_06_case_1_new'
    trainset_idxes = [0,11,13,14,15,18,35] # front all, sample rate 
    testset_idxes = [22,24] # front only, sample rate 
    train_sample_ratio = 1/6
    test_sample_ratio = 1/6
    train_sensors = [
            'CAM_FRONT_CENTER',
            'CAM_FRONT_LEFT',
            'CAM_FRONT_RIGHT',
