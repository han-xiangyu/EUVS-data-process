    ...
    for traversal_idx in merged_traversal_idxes:
        ...
        for idx, sample_token in enumerate(all_sample_tokens):
            ...
            if idx not in skip_indices: ########### Sample data in certain ratio ##############
                ...
                if traversal_idx == 32 and 90<idx<330:
                    continue
...
def main():
    ...
    nusc = NuScenes(version='v1.1', dataroot=f'/home/xiangyu/Ultra/MARS_multitraversal/location_37/37', verbose=True)

    # # case 1 cross 1 straight and right strait
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_37_case_1'
    # trainset_idxes = [14,20,25,28] # front all, sample rate 8/15
    # testset_idxes = [32] # front all, sample rate 2/9
    # train_sample_ratio = 8/15
    # test_sample_ratio = 2/9
    # train_sensors = [
    #         'CAM_FRONT_CENTER',
    #         'CAM_FRONT_LEFT',
    #         'CAM_FRONT_RIGHT',
    ...
    # # case 2 T cross
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_37_case_2_T_cross'
    # trainset_idxes = [14,20,25,28] # front all, sample rate 8/15
    # testset_idxes = [31] # front all, sample rate 2/9
    # train_sample_ratio = 8/15
    ...
    # # case 3 T cross
    # output_dir = '/home/xiangyu/Ultra/MARS_multitraversal/processed_data/loc_37_case_3_T_cross'
    # trainset_idxes = [14,20,25,28] # front all, sample rate 8/15
    # testset_idxes = [5] # front all, sample rate 2/9
    # train_sample_ratio = 8/15
    ...
    output_dir = '/home/xiangyu/Common/MemoGaussian/loc37'
    trainset_idxes = [25,28, 14, 20] # front all, lots of cars 14,20 
    # trainset_idxes = []
    testset_idxes = []  
