...
def save_images(nusc, output_dir, traversal_idxes, testset_idx=None):
    distortion_coefficients = [0.122235, -1.055498, 2.795589, -2.639154]
    ...
    for traversal_idx in traversal_idxes:
        ...
        if traversal_idx in testset_idx:
            TESTSET = True
            sample_ratio = 1/3
        else:
            TESTSET = False
...
def main():
    ...
    # traversal_idxes = [1,5,6,7,8,10,11] # location 11
    # traversal_idxes = [1,2,3,4,5,6] # location 27
    # traversal_idxes = [11,13,14,20,21,22,23,30,47,50] # location 62
    # traversal_idxes = [1,2,3,4,5,6,8,9,17,21] # location 06
    # traversal_idxes = [1,2,3,4,5,6,8,9,10] # location 03
    # traversal_idxes = [1,2,3,4,5,6,8,9,10] # location 61
    # traversal_idxes = [1,2,3,6,9,17,21] # location 06
    # traversal_idxes = [1,2,3,6,9,17,21] # location 59
    # traversal_idxes = [1,2,3,17] # location 06 Untraveled route 6,9,21 as tests
    # traversal_idxes = [6,9,21] # location 06 Untraveled route 6,9,21 as tests
    # traversal_idxes = [1,2,3,17,6,9,21] # location 06 front train, side as tests
    # traversal_idxes = [0,1,4,5,17,30] # location 03 
    # testset_idx = [30] # location 03 testset
    # traversal_idxes = [30]

    # traversal_idxes = [1,4,7,21] # location 26 untraveled 14 as test
    # traversal_idxes = [14]
    # traversal_idxes = [1,4,7,21,8,14,22,23,38,40] # location 26 front train side test
    
    # traversal_idxes=[0,11,13,14,15,18,31,33,34,35] # location 06 10days front only
    # testset_idx = [0,15] # location 06 10days front only testset
    # traversal_idxes=[0,11,13,14,15,18,35,22,24] # location 06 10days all cam
    # testset_idx = [22,24] # location 06 10days all cam testset

    # traversal_idxes=[2,5,9,11,14,15,58,56,62,24] # location 26 front only
    # testset_idx = [62,24] # location 26 front only cam testset

    # traversal_idxes=[2,5,9,11,14,15,58,56,62,24] # location 26 all cam
    # testset_idx = [62,24] # location 26 all cam testset

    # traversal_idxes=[1,3,4,5,6,7,0,15,17] # location 11 front only
    # testset_idx = [0,15,17] # location 06 10days all cam testset



    
    save_images(nusc,output_dir,traversal_idxes, testset_idx)
